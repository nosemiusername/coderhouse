...
exports.productRouter.use(express_1.default.static('public'));
...
exports.productRouter.delete('/remove/:idProduct', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var cart, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
exports.productRouter.get('/show/:idProduct', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var products;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, functions_1.obtainProductById(parseInt(req.params.idProduct))];
            case 1:
                products = _a.sent();
