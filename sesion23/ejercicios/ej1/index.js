...
const normaliZedEmpledados = normalize(empresa,empresaSchema);
console.log(util.inspect(normaliZedEmpledados,false,12,true));
console.log(JSON.stringify(normaliZedEmpledados).length);
const deNormaliZedEmpledados = denormalize(normaliZedEmpledados.result,empresaSchema, normaliZedEmpledados.entities);
